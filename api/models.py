...
class  PurchaseOrder(models.Model):
    po_number = models.CharField(max_length=255, unique=True, help_text="Unique number identifying the PO")
    ...
    status = models.CharField(max_length=100, help_text="Current status of the PO (e.g., pending, completed, canceled)")
    quality_rating = models.FloatField(null=True, blank=True, help_text="Rating given to the vendor for this PO")
